...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { absent: @attendance.absent, late: @attendance.late, present: @attendance.present } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { absent: @attendance.absent, late: @attendance.late, present: @attendance.present } }
